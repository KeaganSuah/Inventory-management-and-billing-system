...
for row in readr:
    inventory_dict[row[0]]= [row[1],row[2],row[3],row[4],row[5],row[6]]
...
def show_features(item, feature):
    ...
    return('Model Number : ' + str(item) + ' | name : ' + str(feature[0])+ ' | colour : ' + str(feature[3]) + '| size : ' +str(feature[4]) + '| Qty : ' + str(feature[2]) + '| location : ' + str(feature[5]))  
...
def billing_list(list):
    ...
    for item, feature in list.items():
        if product_type == feature[4]:
            print(show_features(item, feature).replace('Model Number : ' + str(item),'').replace('| size : ' +str(feature[4]) + '| Qty : ' + str(feature[2]) + '| location : ' + str(feature[5]),'') + ' | price : $' + str(feature[1]))
    print('------------------')            
